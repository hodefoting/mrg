...
local shapes={
  ...
  {e = Mrg.PRESS,        x=300, y=175, rad=20, stopPropagate=1, r=1,g=0,b=0,a=0.8},
  {e = Mrg.RELEASE,      x=60, y=300, rad=20, stopPropagate=1, r=1,g=0,b=0,a=0.8},
  {e = Mrg.DRAG_PRESS,   x=180, y=300, rad=20, stopPropagate=1, r=1,g=0,b=0,a=0.8},
}
...
mrg:set_ui(function()
  local cr = mrg:cr()
    mrg:print('tap, tap and hold, press\n')
    mrg:print('release drag_press\n')
  ...
  cr:rectangle(60,175,400,125)
  cr:set_source_rgba(0,0,1,0.2)
  mrg:listen(Mrg.DRAG, function(event)
    pan = pan + event.delta_y
    mrg:queue_draw(nil)
  end)
  cr:fill()
end)
