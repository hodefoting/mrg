...
{
  mrg_image (mrg, 0, 10, 32, -1,    1,"hodefoting.png", NULL, NULL);
  mrg_image (mrg, 40, 10, 64, -1,   1,"hodefoting.png", NULL, NULL);
  mrg_image (mrg, 128, 10, -1, 64,  1,"hodefoting.png", NULL, NULL);
  mrg_image (mrg, 196, 10, -1, 128, 1,"hodefoting.png", NULL, NULL);
  mrg_image (mrg, 10, 196, -1, -1, 1,"hodefoting.png", NULL, NULL);
